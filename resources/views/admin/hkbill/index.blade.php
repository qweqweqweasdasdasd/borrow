                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-manage">
                                            @if($v->status == 4)
                                            <a title="请求扣除" class="layui-btn layui-btn-xs" onclick="member_del(this,'{{$v->b_id}}')" href="javascript:;">请求扣款</a>
                                            @endif
                                              <a title="备注" class="layui-btn layui-btn-normal layui-btn-xs" onclick="xadmin.open('编辑','/admin/hkbill/{{$v->b_id}}/edit',600,800,true)" href="javascript:;">备注</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
<script>
    ...
    function member_del(obj, id) {
        layer.confirm('确认需要扣除吗？',function(index) {
            //发异步删除数据
